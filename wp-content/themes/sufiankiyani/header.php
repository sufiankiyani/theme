...
<html>
  <head>
    ...
    <!-- owl carousel-->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/vendor/owl.carousel/assets/owl.carousel.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/vendor/owl.carousel/assets/owl.theme.default.css">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/css/style.default.css" id="theme-stylesheet">
    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.html" class="navbar-brand home"><img src="<?php echo get_template_directory_uri();?>/img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
                ...
                <ul class="dropdown-menu megamenu">
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3">
                        <div class="banner"><a href="#"><img src="<?php echo get_template_directory_uri();?>/img/banner.jpg" alt="" class="img img-fluid"></a></div>
                        <div class="banner"><a href="#"><img src="<?php echo get_template_directory_uri();?>/img/banner2.jpg" alt="" class="img img-fluid"></a></div>
                      </div>
                    </div>
                  </li>
                </ul>
