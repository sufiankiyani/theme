...
function clean_custom_menus() {
	...
	if (($locations = get_nav_menu_locations()) && isset($locations[$menu_name])) {
		...
		$menu_list = '<nav class="navbar navbar-expand-md  navbar-light bg-light">' ."\n";
		$menu_list = '<div class="container">' ."\n";
		$menu_list = '<div class="collapse navbar-collapse" id="navbarMenu">' ."\n";
		$menu_list .= "\t\t\t\t". '<ul class="navbar-nav mx-auto">' ."\n";
